...
(defun insert-n (alist anumber anindex)
  (cond
  	((null alist )(append(list anumber) alist))
    ((< anindex 0) (print "not valid index"))
    ((= anindex 0) (append(list anumber) alist))
    ((endp alist) (print "not valid index"))
    (t (cons (first alist) (insert-n anumber (rest alist) (1- anindex))))))
